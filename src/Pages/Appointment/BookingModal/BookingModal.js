...
const BookingModal = ({ treatment, setTreatment, selectedDate, refetch }) => {
    const { name: treatmentName, price, slots } = treatment; // treatment is just another name of appointmentOptions with name,slots,_id
            ...
            <div className="modal">
                <div className="modal-box relative">
                    ...
                    <form onSubmit={handleBooking} className='grid grid-cols-1 gap-3 mt-10'>
                        <input type="text" disabled value={date} placeholder="Type here" className="input input-bordered " />
                        ...
                        <input className='btn btn-accent w-full  max-w-sm' type="submit" value="Submit"></input>
                    </form>
                </div>
            </div>
        </>
